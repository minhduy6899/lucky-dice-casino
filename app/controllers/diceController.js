...
const getDiceHistoryByUser = (request, response) => {
    console.log('hello');
    // B1: Chuẩn bị dữ liệu data
                                                        ...
                                                        if (last3DiceHistory.length < 3) {
                                                            ...
                                                            if (!checkHavePrize) {
                                                                ...
                                                                prizeModel.count().exec((errorCountPrize, countPrize) => {
                                                                    ...
                                                                    console.log('check random: ', randomPrize);
